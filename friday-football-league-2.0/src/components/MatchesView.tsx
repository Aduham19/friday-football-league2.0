                  ...
                  <div className={`p-2 rounded-xl text-xs flex items-center justify-between border ${
                    ...
                    <div className="flex items-center space-x-1.5 truncate">
                      ...
                      <span className="font-bold truncate text-[11px]">
                        ...
                        <span className="text-sky-400">🔵 {match.matchSheet.teamBName}</span>
                      </span>
                    </div>
                    ...
                    {match.matchSheet.winner === 'teamB' && (
                      <span className="px-1.5 py-0.5 bg-sky-500 text-white text-[10px] font-black rounded shrink-0 ml-1.5 shadow-sm">
